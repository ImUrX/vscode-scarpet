...
export class ScarpetSet extends Set<vscode.CompletionItem> {
    ...
    constructor() {
        ...
        super([
            ...
            new vscode.CompletionItem("__on_player_uses_item(player, item_tuple, hand)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_releases_item(player, item_tuple, hand)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_finishes_using_item(player, item_tuple, hand)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_clicks_block(player, block, face)", typesEnum.Event),
            new vscode.CompletionItem("__on_player_breaks_block(player, block)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_right_clicks_block(player, item_tuple, hand, block, face, hitvec)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_interacts_with_block(player, hand, block, face, hitvec)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_places_block(player, item_tuple, hand, block)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_interacts_with_entity(player, entity, hand)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_attacks_entity(player, entity)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_rides(player, forward, strafe, jumping, sneaking)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_jumps(player)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_deploys_elytra(player)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_wakes_up(player)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_starts_sneaking(player)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_stops_sneaking(player)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_starts_sprinting(player)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_stops_sprinting(player)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_drops_item(player)->", typesEnum.Event),
            new vscode.CompletionItem("__on_player_drops_stack(player)->", typesEnum.Event),
            new vscode.CompletionItem("__on_statistic(player, category, event, value)->", typesEnum.Event),
            //      Misc
